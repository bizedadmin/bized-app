...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white dark:bg-[#0B141A]">
          ...
          <div className="mt-8">
            ...
            <div className="mt-6 space-y-5">
              ...
              <p className="text-center text-sm text-gray-500 mt-6">
                Don't have an account? <a href="/signup" className="text-[#25D366] hover:text-[#1fba58] font-bold">Sign up free</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="hidden lg:block relative w-0 flex-1 bg-[#075E54]">
        <div className="absolute inset-0 h-full w-full object-cover">
          <div className="h-full w-full flex flex-col items-center justify-center p-12 text-center text-white">
            <h3 className="text-4xl font-black mb-6">Manage Everything.</h3>
            <p className="text-lg text-white/80 max-w-md">
              Your entire business operation synced perfectly across WhatsApp, Web, and Native.
            </p>
          </div>
        </div>
      </div>
